...
export class GL_RenderableBase extends AbstractionBase
{
	 ...
	 *
	 */
	public _materialGroup:MaterialGroupBase;
	 ...
	 * @param renderer
	 */
	constructor(renderable:IRenderable, renderablePool:RenderablePool)
	{
		super(renderable, renderablePool);
		...
		//store references
		this.sourceEntity = renderablePool.entity;
		this._materialGroup = renderablePool.materialGroup;
		this._stage = this._materialGroup.stage;
