...
module away.materials
{
	...
	export class ShaderCompilerHelper
	{
		/**
		 ...
		 * @protected
		 */
		public static getTex2DSampleCode(targetReg:ShaderRegisterElement, sharedReg:ShaderRegisterData, inputReg:ShaderRegisterElement, texture:away.textures.TextureProxyBase, smooth:boolean, repeat:boolean, mipmaps:boolean, uvReg:ShaderRegisterElement = null, forceWrap:string = null):string
		{
		 ...
		 * @protected
		 */
		public static getTexCubeSampleCode(targetReg:ShaderRegisterElement, inputReg:ShaderRegisterElement, texture:away.textures.TextureProxyBase, smooth:boolean, mipmaps:boolean, uvReg:ShaderRegisterElement):string
		{
			var filter:string;
			var format:string = ShaderCompilerHelper.getFormatStringForTexture(texture);
			var enableMipMaps:boolean = mipmaps && texture.hasMipmaps;
		 ...
		 * @protected
		 */
		public static getFormatStringForTexture(texture:away.textures.TextureProxyBase):string
		{
